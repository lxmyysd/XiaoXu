...
local Window = library:new("染春(HCD)脚本")

local krx = Window:Tab("信息",'111810906443865')
local bin = krx:section("玩家信息",true)
local about = krx:section("作者信息",true)
local UI = krx:section("UI设置",true)

local Main = Window:Tab("主要",'111810906443865')
...
local JSDGt = Window:Tab("驾驶帝国",'111810906443865')
local JSDG = JSDGt:section("自动&刷钱",true)

local FMDHt = Window:Tab("伐木大亨2",'111810906443865')
local FMDH = FMDHt:section("伐木大亨2",true)

local SKQSt = Window:Tab("鲨口求生2",'111810906443865')
local SKQS = SKQSt:section("鲨口&求生",true)

local DoorsT = Window:Tab("doors",'111810906443865')
...
local JSCQt = Window:Tab("极速传奇",'111810906443865')
local JSCQ = JSCQt:section("自动&玩家",true)
local JSQC = JSCQt:section("传送位置",true)

local RZCQt = Window:Tab("忍者传奇",'111810906443865')
